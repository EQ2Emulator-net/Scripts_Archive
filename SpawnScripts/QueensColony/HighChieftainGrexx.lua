...
function hailed(NPC, Spawn)
   if HasQuest(Spawn, 56) and GetQuestStep(Spawn, 56) == 8 then
      SetStepComplete(Spawn, 56, 8)
   end
   ...
   elseif HasQuest(Spawn, 31) then
      if GetQuestStep(Spawn, 31) == 6 then
         SadTimes(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 7 then
         HeroMustGo(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 8 then
         Prophecy(NPC, Spawn)
      else
         RebuildWeWill(NPC, Spawn)
      end
