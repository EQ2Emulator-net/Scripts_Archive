...
function hailed(NPC, Spawn)
   ...
   elseif HasQuest(Spawn, 3) then
      if GetQuestStep(Spawn, 3) == 1 then
         listenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 2 then
         SetStepComplete(Spawn, 3, 2)
         --ListenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 3 then
         listenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 4 then
         SetStepComplete(Spawn, 3, 4)
         --ListenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 5 then
         listenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 6 then
         listenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 7 then
         SetStepComplete(Spawn, 3, 7)
      elseif GetQuestStep(Spawn, 3) == 8 then
         listenToTheSilence(NPC, Spawn)
      elseif GetQuestStep(Spawn, 3) == 9 then
