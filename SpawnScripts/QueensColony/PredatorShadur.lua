...
function hailed(NPC, Spawn)
   ...
   if HasQuest(Spawn, 9) then
      if GetQuestStep(Spawn, 9) == 1 then
         -- on step 1
      ...
      elseif GetQuestStep(Spawn, 9) == 2 or GetQuestStep(Spawn, 9) == 4 then
         -- on step 2
      ...
      elseif GetQuestStep(Spawn, 9) == 3 then
          -- on step 3
      ...
      elseif GetQuestStep(Spawn, 9) == 5 then
         Step5Complete(NPC, Spawn)
      else
         GivenHope(NPC, Spawn)
      end
   elseif HasCompletedQuest(Spawn, 9) then
      GivenHope(NPC, Spawn)
   else
