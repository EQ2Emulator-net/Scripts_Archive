...
function hailed(NPC, Spawn)
   ...
   elseif HasQuest(Spawn, 31) then
      if GetQuestStep(Spawn, 31) == 1 then
         LoveThisJob(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 2 then
         KeepLooking(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 3 then
         CausedAnUproar(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 4 then
         INeedToStayBack(NPC, Spawn)
      elseif GetQuestStep(Spawn, 31) == 5 then
