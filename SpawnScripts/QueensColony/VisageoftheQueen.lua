--[[
	Script Name	: SpawnScripts/Generic/QueenAntoniaBayle.lua
	Script Purpose	: Queen Antonia Bayle 
	Script Author	: John Adams
	Script Date	: 2009.01.15
	Script Notes	: For talking statues - need more of the dialog, and a timer trigger instead of proximity.
--]]
