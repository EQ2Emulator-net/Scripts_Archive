...
function hailed(NPC, Spawn)
   ...
   elseif HasQuest(Spawn, 30) then
      if GetQuestStep(Spawn, 30) == 1 then
         DoNotFret(NPC, Spawn)
      elseif GetQuestStep(Spawn, 30) == 2 then
         KeepTrying(NPC, Spawn)
      elseif GetQuestStep(Spawn, 30) == 3 then
         GreatGame(NPC, Spawn)
      elseif GetQuestStep(Spawn, 30) == 4 then
         ClearMorak(NPC, Spawn)
      elseif GetQuestStep(Spawn, 30) == 5 then
...
function GreatGame(NPC, Spawn)
   ...
   StartConversation(conversation, NPC, Spawn, "That was a great game of cat and mouse you pulled there! Nice job, but now for the fun part.")
end

function dlg_21_1(NPC, Spawn)
   SetStepComplete(Spawn, 30, 3)
