...
function hailed(NPC, Spawn)
   ...
   if HasQuest(Spawn, 7) and GetQuestStep(Spawn, 7) < 6 then
      if GetQuestStep(Spawn, 7) == 1 then
	 ...
	 AddConversationOption(conversation, "I'll come back. It seems that you're busy.")
      ...
      elseif GetQuestStep(Spawn, 7) == 2 then
      ...
      elseif GetQuestStep(Spawn, 7) == 3 then
	 ...
	 AddConversationOption(conversation, "Not yet.")
      ...
      elseif GetQuestStep(Spawn, 7) == 4 then
      ...
      elseif GetQuestStep(Spawn, 7) == 5 then
         --on 5th part of quest
         SetStepComplete(Spawn, 7, 5)
   ...
   elseif HasCompletedQuest(Spawn, 7) or (HasQuest(Spawn, 7) and GetQuestStep(Spawn, 7) == 6) then
