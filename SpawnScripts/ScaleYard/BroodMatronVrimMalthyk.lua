...
local IKSAR = 10
QUEST_1 = 142 --A Puppy for your potion--
QUEST_2 = 151 --He said, he said--
QUEST_3 = 152 --Paying homage to the past--
QUEST_4 = 162 --Kill or be killed--
QUEST_5 = 191 --Report To Enforcer Kurdek
		...
		if HasCompletedQuest(Spawn, QUEST_2) then
			...
			elseif HasQuest(Spawn, QUEST_3) then
				if GetQuestStep(Spawn, QUEST_3) == 6 then
					...
					Say(NPC, "This Conversation is not parsed yet", Spawn)
				end
			else
				dlg_2_1(NPC, Spawn)
			end			
...
function dlgnotcollected(NPC, Spawn)
	FaceTarget(NPC, Spawn)
	Say(NPC, "This conversation option is not collected yet!", Spawn)
end
	...
	function dlg_1_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim003.mp3", "", "", 918892922, 4039686777, Spawn)
		AddConversationOption(conversation, "What is it you would have me do?", "dlg_1_2")
		StartConversation(conversation, NPC, Spawn, "Excellent, I see you know just whom to make friends with. Make enemies with the wrong sort of folk here and you'll find yourself killed in a most gruesome, yet interesting manner.")
	end
	...
	function dlg_2_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim030.mp3", "", "", 757094625, 908041128, Spawn)
		AddConversationOption(conversation, "How may I be of service?", "dlg_2_2")
		AddConversationOption(conversation, "I need to get going now.")
		StartConversation(conversation, NPC, Spawn, "When you have time I recommend you visit the Arcane Academy of Science in North Freeport to learn more about our birthplace, Kunark and the might of the Iksar. I also encourage you travel these lands and seek out knowledge. In the mean time, I would like your further assistance.")
	end
	...
	function dlg_2_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim033.mp3", "", "", 3997214161, 2851942903, Spawn)
		AddConversationOption(conversation, "I suppose I could do that.", "dlg_2_3")
		StartConversation(conversation, NPC, Spawn, "Poor Issik is so busy trying to track down the criminal that ransacked his office that he hasn't had time to take care of some of his... administrative duties. I'm sure you could help him, couldn't you?")
	end
	...
	function dlg_2_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim034.mp3", "", "", 2500219231, 1556258908, Spawn)
		AddConversationOption(conversation, "And how am I supposed to do that? I'm not even a member of the Militia!", "dlg_2_4")
		StartConversation(conversation, NPC, Spawn, "Well, it seems one of his men, Anthony Glavias, I believe, has proven to be most incompetent. Rather than deal with piles of transfer notices and disciplinary forms and other such nonsense, I would have you simply relieve him of his duty as a member of the Militia.")
	end
	...
	function dlg_2_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim035.mp3", "", "", 3506678968, 774551287, Spawn)
		AddConversationOption(conversation, "But... won't the other guards notice? Won't they care?", "dlg_2_5")
		StartConversation(conversation, NPC, Spawn, "With a sword! Or a bow... or lightning bolt. A dull spoon for all I care. Simply put, he must be killed.")
	end
	...
	function dlg_2_5(NPC, Spawn)
		...
		AddConversationOption(conversation, "I understand. He will be disposed of immediately!", "dlg_2_6")
	...
	function dlg_3_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim009.mp3", "", "", 197335648, 1866625970, Spawn)
		AddConversationOption(conversation, "Thank you, Brood Matron.", "dlg_3_2")
		StartConversation(conversation, NPC, Spawn, "Oh, you are too good to me ..GetName(Player).. ! Too good. I see you possess the bold intrepidity common to the highest pedigree of our kind. You will go far young one. Very far indeed.")
	end
	...
	function dlg_3_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim010.mp3", "", "", 3169804225, 1881577148, Spawn)
		AddConversationOption(conversation, "Of course!", "dlg_3_3")
		AddConversationOption(conversation, "My time is better spent elsewhere. Good bye.")
		StartConversation(conversation, NPC, Spawn, "Well now, you've proven you can intimidate the weak. However, can you also bend the wills of those below you and manipulate them to do your bidding?")
	end
	...
	function dlg_4_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim038.mp3", "", "", 1894531159, 2959157043, Spawn)
		AddConversationOption(conversation, "I still can't believe no one cared!", "dlg_4_2")
		AddConversationOption(conversation, "He was weak and unfit to serve in the Militia. Weakness must not be tolerated.")
		StartConversation(conversation, NPC, Spawn, "Good, then that's that. A replacement should arrive in a couple days. Let's hope for both our sakes that this one proves to be a little more useful.")
	end
	...
	function dlg_4_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim017.mp3", "", "", 2455418157, 3928748864, Spawn)
		AddConversationOption(conversation, "I know of Barbarians. What of them?", "dlg_4_3")
		AddConversationOption(conversation, "A pity.")
		AddConversationOption(conversation, "They don't seem so bad.")
		AddConversationOption(conversation, "If we killed them all, then perhaps we Iksar could live by ourselves...")
		StartConversation(conversation, NPC, Spawn, "You may have noticed several large squishy things lumbering about this place. Those are called Barbarians, apparently the Overlord has decreed that we must share this place with them.")
	end
	...
	function dlg_4_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim039.mp3", "", "", 1170740682, 3182778261, Spawn)
		AddConversationOption(conversation, "Any one else need... reassignment? ")
		StartConversation(conversation, NPC, Spawn, "Well said! Most well said! I say, you are indeed destined for greatness!")
	end
	...
	function dlg_4_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim041.mp3", "", "", 4228891781, 3096479379, Spawn)
		AddConversationOption(conversation, "Strike-tail!", "dlg_4_4")
		StartConversation(conversation, NPC, Spawn, "Oh, .. GetName(Spawn) .. . You have been most resourceful in everything that I have asked you to do. I'm afraid that I must bid you farewell for now though. I must see to the other Iksar arriving here in Freeport. Go speak to Enforcer Kurdek in the Sprawl. He could most certainly use your help. Strike-tail young one. You do us proud!")
	end
	...
	function dlg_4_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim020.mp3", "", "", 2951123714, 3814243721, Spawn)
		AddConversationOption(conversation, "Anything else?", "dlg_4_5")
		AddConversationOption(conversation, "Lying to a bunch of barbarian doesn't sound like anything I want to be a part of. Good day.")
		StartConversation(conversation, NPC, Spawn, "Oh, it's not that hard really. I recently heard that someone has ransacked the office of Guard Captain Issik here in the Scale Yard and a Barbarian was seen leaving the scene of the crime. Find a brute named Tristan O'Rilley and tell him that another Barbarian, Wesley Tundrafoot fingered him as the culprit. After you tell Tristan, find Wesley and tell him Tristan has accused him of the same crime.")
		OfferQuest(Quest, 144)
	end
	...
	function dlg_5_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim010.mp3", "", "", 3169804225, 1881577148, Spawn)
		AddConversationOption(conversation, "Of course!", "dlg_5_2")
		AddConversationOption(conversation, "My time is better spent elsewhere. Good bye.")
		StartConversation(conversation, NPC, Spawn, "Well now, you've proven you can intimidate the weak. However, can you also bend the wills of those below you and manipulate them to do your bidding?")
	end
	...
	function dlg_5_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim017.mp3", "", "", 2455418157, 3928748864, Spawn)
		AddConversationOption(conversation, "I know of Barbarians. What of them?", "dlg_5_3")
		AddConversationOption(conversation, "A pity.")
		AddConversationOption(conversation, "They don't seem so bad.")
		AddConversationOption(conversation, "If we killed them all, then perhaps we Iksar could live by ourselves...")
		StartConversation(conversation, NPC, Spawn, "You may have noticed several large squishy things lumbering about this place. Those are called Barbarians, apparently the Overlord has decreed that we must share this place with them.")
	...
	function dlg_5_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim020.mp3", "", "", 2951123714, 3814243721, Spawn)
		AddConversationOption(conversation, "Anything else?", "dlg_5_5")
		AddConversationOption(conversation, "Lying to a bunch of barbarian doesn't sound like anything I want to be a part of. Good day.")
		StartConversation(conversation, NPC, Spawn, "Oh, it's not that hard really. I recently heard that someone has ransacked the office of Guard Captain Issik here in the Scale Yard and a Barbarian was seen leaving the scene of the crime. Find a brute named Tristan O'Rilley and tell him that another Barbarian, Wesley Tundrafoot fingered him as the culprit. After you tell Tristan, find Wesley and tell him Tristan has accused him of the same crime.")
		OfferQuest(Quest, 144)
	end
	...
	function dlg_6_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim010.mp3", "", "", 3169804225, 1881577148, Spawn)
		AddConversationOption(conversation, "Of course!", "dlg_6_2")
		AddConversationOption(conversation, "My time is better spent elsewhere. Good bye.")
		StartConversation(conversation, NPC, Spawn, "Well now, you've proven you can intimidate the weak. However, can you also bend the wills of those below you and manipulate them to do your bidding?")
	end
	...
	function dlg_6_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim017.mp3", "", "", 2455418157, 3928748864, Spawn)
		AddConversationOption(conversation, "I know of Barbarians. What of them?", "dlg_6_3")
		AddConversationOption(conversation, "A pity.")
		AddConversationOption(conversation, "They don't seem so bad.")
		AddConversationOption(conversation, "If we killed them all, then perhaps we Iksar could live by ourselves...")
		StartConversation(conversation, NPC, Spawn, "You may have noticed several large squishy things lumbering about this place. Those are called Barbarians, apparently the Overlord has decreed that we must share this place with them.")
	...
	function dlg_6_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim020.mp3", "", "", 2951123714, 3814243721, Spawn)
		AddConversationOption(conversation, "Anything else?", "dlg_6_5")
		AddConversationOption(conversation, "Lying to a bunch of barbarian doesn't sound like anything I want to be a part of. Good day.")
		StartConversation(conversation, NPC, Spawn, "Oh, it's not that hard really. I recently heard that someone has ransacked the office of Guard Captain Issik here in the Scale Yard and a Barbarian was seen leaving the scene of the crime. Find a brute named Tristan O'Rilley and tell him that another Barbarian, Wesley Tundrafoot fingered him as the culprit. After you tell Tristan, find Wesley and tell him Tristan has accused him of the same crime.")
		OfferQuest(Quest, 144)
	end
	...
	function dlg_7_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim010.mp3", "", "", 3169804225, 1881577148, Spawn)
		AddConversationOption(conversation, "Of course!", "dlg_7_2")
		AddConversationOption(conversation, "My time is better spent elsewhere. Good bye.")
		StartConversation(conversation, NPC, Spawn, "Well now, you've proven you can intimidate the weak. However, can you also bend the wills of those below you and manipulate them to do your bidding?")
	end
	...
	function dlg_7_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim017.mp3", "", "", 2455418157, 3928748864, Spawn)
		AddConversationOption(conversation, "I know of Barbarians. What of them?", "dlg_7_3")
		AddConversationOption(conversation, "A pity.")
		AddConversationOption(conversation, "They don't seem so bad.")
		AddConversationOption(conversation, "If we killed them all, then perhaps we Iksar could live by ourselves...")
		StartConversation(conversation, NPC, Spawn, "You may have noticed several large squishy things lumbering about this place. Those are called Barbarians, apparently the Overlord has decreed that we must share this place with them.")
	...
	function dlg_7_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim018.mp3", "", "", 3389510546, 879079764, Spawn)
		AddConversationOption(conversation, "Indeed. Please continue.")
		StartConversation(conversation, NPC, Spawn, "That's what I said! It would make things much simpler! Cut down on the overcrowding, pollution... But alas, no. Something about genocide not being permitted within city limits or some such nonsense. A shame really.")
	end
	...
	function dlg_7_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim019.mp3", "", "", 168409045, 576187712, Spawn)
		AddConversationOption(conversation, "Tell me more.", "dlg_7_5")
		StartConversation(conversation, NPC, Spawn, "Yes, well they have their uses. You see, our neighbors here are highly suggestible and prone to acting on their feelings, often neglecting simple logic. A fact that we Iksar are only so inclined to take advantage of.")
	end
	...
	function dlg_7_5(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim020.mp3", "", "", 2951123714, 3814243721, Spawn)
		AddConversationOption(conversation, "Anything else?", "dlg_7_6")
		AddConversationOption(conversation, "Lying to a bunch of barbarian doesn't sound like anything I want to be a part of. Good day.")
		StartConversation(conversation, NPC, Spawn, "Oh, it's not that hard really. I recently heard that someone has ransacked the office of Guard Captain Issik here in the Scale Yard and a Barbarian was seen leaving the scene of the crime. Find a brute named Tristan O'Rilley and tell him that another Barbarian, Wesley Tundrafoot fingered him as the culprit. After you tell Tristan, find Wesley and tell him Tristan has accused him of the same crime.")
		OfferQuest(Quest, 144)
	end
	...
	function dlg_8_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim010.mp3", "", "", 3169804225, 1881577148, Spawn)
		AddConversationOption(conversation, "Of course!", "dlg_8_2")
		AddConversationOption(conversation, "My time is better spent elsewhere. Good bye.")
		StartConversation(conversation, NPC, Spawn, "Well now, you've proven you can intimidate the weak. However, can you also bend the wills of those below you and manipulate them to do your bidding?")
	end
	...
	function dlg_8_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim017.mp3", "", "", 2455418157, 3928748864, Spawn)
		AddConversationOption(conversation, "I know of Barbarians. What of them?", "dlg_8_3")
		AddConversationOption(conversation, "A pity.")
		AddConversationOption(conversation, "They don't seem so bad.")
		AddConversationOption(conversation, "If we killed them all, then perhaps we Iksar could live by ourselves...")
		StartConversation(conversation, NPC, Spawn, "You may have noticed several large squishy things lumbering about this place. Those are called Barbarians, apparently the Overlord has decreed that we must share this place with them.")
	...
	function dlg_8_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim019.mp3", "", "", 168409045, 576187712, Spawn)
		AddConversationOption(conversation, "Tell me more.", "dlg_8_4")
		StartConversation(conversation, NPC, Spawn, "Yes, well they have their uses. You see, our neighbors here are highly suggestible and prone to acting on their feelings, often neglecting simple logic. A fact that we Iksar are only so inclined to take advantage of.")
	end
	...
	function dlg_8_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim020.mp3", "", "", 2951123714, 3814243721, Spawn)
		AddConversationOption(conversation, "Anything else?", "dlg_8_5")
		AddConversationOption(conversation, "Lying to a bunch of barbarian doesn't sound like anything I want to be a part of. Good day.")
		StartConversation(conversation, NPC, Spawn, "Oh, it's not that hard really. I recently heard that someone has ransacked the office of Guard Captain Issik here in the Scale Yard and a Barbarian was seen leaving the scene of the crime. Find a brute named Tristan O'Rilley and tell him that another Barbarian, Wesley Tundrafoot fingered him as the culprit. After you tell Tristan, find Wesley and tell him Tristan has accused him of the same crime.")
		OfferQuest(Quest, 144)
	end
	...
	function dlg_8_5(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim021.mp3", "", "", 791154437, 3626211974, Spawn)
		AddConversationOption(conversation, "Then, I'm off!", "dlg_8_6")
		StartConversation(conversation, NPC, Spawn, "No, that should be enough to send those two off the deep end. You should be able to find Tristan near the Heated Stone Inn and Wesley tends to lurk around the South Freeport Gate.")
	end
	...
	function dlg_13_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim023.mp3", "", "", 1821929117, 1132414130, Spawn)
		AddConversationOption(conversation, "Um, how do you mean.", "dlg_13_2")
		StartConversation(conversation, NPC, Spawn, "Splendid work, broodling. You've turned those two into bitter enemies with a minimum amount of effort. Do you see the inherent greatness in our kind my silver-tongued catalyst of chaos?")
	end
	...
	function dlg_13_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim024.mp3", "", "", 1213078111, 3741061033, Spawn)
		AddConversationOption(conversation, "Go on.", "dlg_13_3")
		AddConversationOption(conversation, "You call this thriving?")
		StartConversation(conversation, NPC, Spawn, "The Iksar have overcome numerous calamities from enslavement and persecution to civil war. Empires rose and were toppled. Majestic cities founded only to be razed by our enemies. Despite all of that we still survive and continue to thrive.")
	end
	...
	function dlg_13_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim025.mp3", "", "", 1015226008, 2593758640, Spawn)
		AddConversationOption(conversation, "Tell me more!")
		AddConversationOption(conversation, "Um, I'm not looking for any sort of history lesson. Do you have anything else I could do?", "dlg_13_4")
		StartConversation(conversation, NPC, Spawn, "Yes, it may be true that many of our kind now live in destitution, but it is Iksar like yourself, young adventurer, that we look to help our kind once again achieve greatness. ")
	end
	...
	function dlg_13_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim026.mp3", "", "", 3166224232, 2882270872, Spawn)
		AddConversationOption(conversation, "Continue.")
		StartConversation(conversation, NPC, Spawn, "I haven't the time to give you an accurate history of the Iksar at this time, though it would behoove you to learn more about your forefathers. We have overcome perils and accomplished feats no other race could come close to achieving! ")
	end
	...
	function dlg_13_5(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim027.mp3", "", "", 945509375, 1619107607, Spawn)
		AddConversationOption(conversation, "I will do as you ask.", "dlg_13_6")
		StartConversation(conversation, NPC, Spawn, "I was about to perform a ritual that is often performed to reflect upon the history of our ancestors. However, I believe it would be more beneficial if you performed the ritual. Here, take this tome. Read the passage I have bookmarked and perform the tasks it mentions.")
		OfferQuest(Quest, 145)
	end
	...
	function dlg_13_6(NPC, Spawn)
		...
		AddConversationOption(conversation, "I take my leave.", "dlg_13_7")
	...
	function dlg_14_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim032.mp3", "", "", 1914572947, 207925594, Spawn)
		AddConversationOption(conversation, "Indeed I do. Tell me more.")
		AddConversationOption(conversation, "I need to get going now.")
		StartConversation(conversation, NPC, Spawn, "I find your mockery... distasteful. You should think twice before dismissing the accomplishments of those before you. After all, you might not be here if it were not for them. Regardless, I can tell by your restless nature that you wish to sink your teeth into something... a bit more physical, yes? I have just the task for you.")
	end
	...
	function dlg_15_2(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim033.mp3", "", "", 3997214161, 2851942903, Spawn)
		AddConversationOption(conversation, "I suppose I could do that.", "dlg_15_3")
		StartConversation(conversation, NPC, Spawn, "Poor Issik is so busy trying to track down the criminal that ransacked his office that he hasn't had time to take care of some of his... administrative duties. I'm sure you could help him, couldn't you?")
	end
	...
	function dlg_15_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim034.mp3", "", "", 2500219231, 1556258908, Spawn)
		AddConversationOption(conversation, "And how am I supposed to do that? I'm not even a member of the Militia!", "dlg_15_4")
		StartConversation(conversation, NPC, Spawn, "Well, it seems one of his men, Anthony Glavias, I believe, has proven to be most incompetent. Rather than deal with piles of transfer notices and disciplinary forms and other such nonsense, I would have you simply relieve him of his duty as a member of the Militia.")
	end
	...
	function dlg_15_4(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim035.mp3", "", "", 3506678968, 774551287, Spawn)
		AddConversationOption(conversation, "But... won't the other guards notice? Won't they care?", "dlg_15_5")
		StartConversation(conversation, NPC, Spawn, "With a sword! Or a bow... or lightning bolt. A dull spoon for all I care. Simply put, he must be killed.")
	end
	...
	function dlg_15_5(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim036.mp3", "", "", 3345203705, 2408614113, Spawn)
		AddConversationOption(conversation, "I understand. He will be disposed of immediately!", "dlg_15_6")
		StartConversation(conversation, NPC, Spawn, "Let me tell you something. After the Iksar proved their mettle tenfold to the Overlord, he pretty much allows us to run this yard anyway we see fit. Militia members included. If someone's not up to snuff... replace them.")
	end
	...
	function dlg_17_1(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim038.mp3", "", "", 1894531159, 2959157043, Spawn)
		AddConversationOption(conversation, "I still can't believe no one cared!", "dlg_17_2")
		AddConversationOption(conversation, "He was weak and unfit to serve in the Militia. Weakness must not be tolerated.")
		StartConversation(conversation, NPC, Spawn, "Good, then that's that. A replacement should arrive in a couple days. Let's hope for both our sakes that this one proves to be a little more useful.")
	end
	...
	function dlg_17_3(NPC, Spawn)
		...
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/rcp_vrim041.mp3", "", "", 4228891781, 3096479379, Spawn)
		AddConversationOption(conversation, "Strike-tail!", "dlg_17_4")
		StartConversation(conversation, NPC, Spawn, "Oh," ..GetName(player).. ". You have been most resourceful in everything that I have asked you to do. I'm afraid that I must bid you farewell for now though. I must see to the other Iksar arriving here in Freeport. Go speak to Enforcer Kurdek in the Sprawl. He could most certainly use your help. Strike-tail young one. You do us proud!")
	end
--]]
	--[[ raw_conversations
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/quest_vrim_finish_quest3_90a5a96e.mp3", "You're back, yet you have not finished the ritual. Do so before speaking to me again.", "", 2668109561, 1751413985, Spawn)
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/quest_vrim_finish_quest4_8b5005c8.mp3", "You return to me with no blood on your claws? Finish your task and then return to me.", "", 2222768719, 617970237, Spawn)
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/quest_vrim_done_569ac291.mp3", "Thanks again for your help. May your adventures yield you great riches and your enemies quiver in fear at the mere mention of your name.", "", 2115710919, 948239985, Spawn)
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/quest_vrim_non_iksar_b4395ade.mp3", "Yzk ckz usyevyvhcj A dmft pvmbvz bd qgc izcvvjjk lmocygpbdzs", "", 1560600840, 3844234630, Spawn)
		PlayFlavor(NPC, "voiceover/english/tutorial_revamp/brood_matron_vrim_malthyk/fprt_hood06/quest_vrim_non_iksar_b4395ade.mp3", "Not now soft-skin. I must attend to the arriving broodlings.", "", 1560600840, 3844234630, Spawn)
	--]]
