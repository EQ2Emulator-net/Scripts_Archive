...
local BARBARIAN = 0
QUEST_1 = 175 --Wasp What I Can Do
QUEST_2 = 183 --Sound Off!
QUEST_3 = 185 --Battle On The Home Front
QUEST_4 = 186 --What Happens In The Scale Yard Stays...
QUEST_5 = 188 --Go Visit The Sprawl
...
function SmashingDone(NPC, Spawn)
	...
	StartConversation(conversation, NPC, Spawn, "Ahoy there. I've herd that Issik's homeis... a bit disheveled now. Is this true?")	
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
