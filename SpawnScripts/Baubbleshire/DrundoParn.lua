...
function hailed(NPC, Spawn)
	...
	if HasQuest(Spawn, 28) and not QuestStepIsComplete(Spawn, 28, 2) then
	...
	elseif HasCompletedQuest(Spawn, 72) then
	...
	elseif HasQuest(Spawn, 72) then
		if GetQuestStep(Spawn, 72) >= 2 and not QuestStepIsComplete(Spawn, 72, 2) then
