...
function hailed(NPC, Spawn)
	...
	if HasQuest(Spawn, 70) and GetQuestStep(Spawn, 70) == 1 then
		WaterfallCalming(NPC, Spawn)
	elseif HasQuest(Spawn, 71) and GetQuestStep(Spawn, 71) == 2 then
