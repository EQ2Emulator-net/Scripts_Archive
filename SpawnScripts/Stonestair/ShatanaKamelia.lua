--[[
	...
	Script Purpose	: Shatana Kamelia <Crafting Trainer>
...
function hailed(NPC, Spawn)
	...
	AddConversationOption(conversation, "Yes, please teach me.", "dlg_25_1")
...
function dlg_25_1(NPC, Spawn)
	...
	AddConversationOption(conversation, "I will start on that now.", "dlg_25_2")
