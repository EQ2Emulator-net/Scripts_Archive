...
function hailed(NPC, Spawn)
   ...
   if HasCompletedQuest(Spawn, 36) then
      AllMannerOfFermented(NPC, Spawn)
   elseif HasQuest(Spawn, 36) then
      if GetQuestStep(Spawn, 36) == 2 then
