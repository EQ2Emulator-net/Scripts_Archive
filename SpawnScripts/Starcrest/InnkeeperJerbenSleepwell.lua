...
function hailed(NPC, Spawn)
	...
	AddConversationOption(conversation, "Yes, please.", "dlg_9_1")
	AddConversationOption(conversation, "No thank you.")
	StartConversation(conversation, NPC, Spawn, "Hello Jinoira, I am the Innkeeper for this village.  We have received word of your arrival and have a room prepared for you.  Would you like to know more about housing?")
end
