...
function hailed(NPC, Spawn)
	...
	elseif HasQuest(Spawn, 32) then
		if GetQuestStep(Spawn, 32) == 1 then
...
function HaveYouCollectedBerries(NPC, Spawn)
	...
	if GetQuestStep(Spawn, 32) == 2 then
		AddConversationOption(conversation, "Not yet.")
	elseif (HasCompletedQuest(Spawn, 32) and not HasCompletedQuest(Spawn, 33)) or (HasQuest(Spawn, 32) and GetQuestStep(Spawn, 32) == 3) then
