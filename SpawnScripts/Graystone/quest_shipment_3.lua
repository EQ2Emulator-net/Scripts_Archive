...
function casted_on(Target, Caster, SpellName)
	-- Location Buoys
	if HasQuest(Caster, BARBARIAN_MENTOR_QUEST_3) and not QuestStepIsComplete(Caster, BARBARIAN_MENTOR_QUEST_3, 3) and HasItem(Caster, 7755) then
...
function AttachBuoy(NPC, Spawn)
	...
	local Buoy = SpawnMob(GetZone(NPC), 2350097, false, 953.05, -27.15, -148.67)
	Despawn(Buoy, 120000)
end