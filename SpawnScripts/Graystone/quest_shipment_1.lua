...
function casted_on(Target, Caster, SpellName)
	-- Location Buoys
	if HasQuest(Caster, BARBARIAN_MENTOR_QUEST_3) and not QuestStepIsComplete(Caster, BARBARIAN_MENTOR_QUEST_3, 1) and HasItem(Caster, 7755) then
...
function AttachBuoy(NPC, Spawn)
	...
	Buoy = SpawnMob(GetZone(NPC), 2350097, false, 973.77, -26.085, -143.197)
	Despawn(Buoy, 120000)
end