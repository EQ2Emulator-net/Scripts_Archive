...
function hailed(NPC, Spawn)
   ...
   elseif HasQuest(Spawn, 11) then
      if GetQuestStep(Spawn, 11) == 1 then
      ...
      elseif GetQuestStep(Spawn, 11) == 2 then
      ...
      elseif GetQuestStep(Spawn, 11) == 3 then
         SetStepComplete(Spawn, 11, 3)
      ...
      elseif GetQuestStep(Spawn, 11) == 4 then
      ...
      elseif GetQuestStep(Spawn, 11) == 5 then
         SetStepComplete(Spawn, 11, 5)
