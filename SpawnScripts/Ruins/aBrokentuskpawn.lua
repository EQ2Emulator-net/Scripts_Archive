...
function StartPath1(NPC)
	MovementLoopAddLocation(NPC, -120.64, -2.58, 17.04, 8, 0)
	MovementLoopAddLocation(NPC, -89.23, -2.69, 25, 8, 0)
	MovementLoopAddLocation(NPC, -53.93, -2.63, 27.08, 8, 0)
	MovementLoopAddLocation(NPC, -55.71, -2.52, 33.44, 8, 0)
	MovementLoopAddLocation(NPC, -89.93, -2.74, 36.69, 8, 0)
	MovementLoopAddLocation(NPC, -103.84, -2.64, 22.62, 8, 0)
	MovementLoopAddLocation(NPC, -120.87, -2.6, 19.65, 8, 0)
	MovementLoopAddLocation(NPC, -135.95, -2.61, 31.13, 8, 0)
	MovementLoopAddLocation(NPC, -138.46, -2.58, 23.24, 8, 0)
end

function StartPath2(NPC)
	MovementLoopAddLocation(NPC, -119.97, 2.26, 127.77, 8, 0)
	MovementLoopAddLocation(NPC, -123.42, 0.92, 107.14, 8, 0)
	MovementLoopAddLocation(NPC, -123.68, -2.62, 73.93, 8, 0)
	MovementLoopAddLocation(NPC, -101.58, -2.56, 63.45, 8, 0)
	MovementLoopAddLocation(NPC, -96.64, -2.59, 75.03, 8, 0)
	MovementLoopAddLocation(NPC, -119.92, -2.63, 94.64, 8, 0)
	MovementLoopAddLocation(NPC, -119.77, 2.26, 128.79, 8, 0)
	MovementLoopAddLocation(NPC, -127.08, 2.26, 141.62, 8, 0)
end

function StartPath3(NPC)
	MovementLoopAddLocation(NPC, -122.63, 2.28, 120.17, 8, 0)
	MovementLoopAddLocation(NPC, -123.33, -1.71, 98.13, 8, 0)
	MovementLoopAddLocation(NPC, -97.93, -2.42, 71.18, 8, 0)
	MovementLoopAddLocation(NPC, -91.85, -2.63, 52.03, 8, 0)
	MovementLoopAddLocation(NPC, -97.82, -2.45, 53.78, 8, 0)
	MovementLoopAddLocation(NPC, -118.73, -2.54, 74.65, 8, 0)
	MovementLoopAddLocation(NPC, -123.79, -2.62, 75.76, 8, 0)
	MovementLoopAddLocation(NPC, -123.07, 2.28, 120.49, 8, 0)
	MovementLoopAddLocation(NPC, -149.83, 2.26, 142.84, 8, 0)
end