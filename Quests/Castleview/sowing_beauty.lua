...
function step1_complete_plantedSeed1(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 61) then
...
function seeds_planted(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 9, "I need to return to Vindain near The Fountain of Valor.", 1, "I need to return to Vindain and let him know of the planted seeds, especially the one that went wrong.", 0, 2360047)
