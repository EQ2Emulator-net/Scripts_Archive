...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "I need to find the spririt of the sprite that attacked me and speak with it.", 1, "I need to find the spirit of the fallen sprite.", 0, 2360100)
...
function step1_complete_talkedToSpirit(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to return to Vindain Greenfaith.", 1, "I need to find the spirit of the fallen sprite.", 0, 2360047)
