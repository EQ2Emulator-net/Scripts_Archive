--[[
	Script Name	: Quests/Starcrest/meeting_with_cayan.lua
...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "I need to speak with Cayan Sable, he is in a hiding spot that can be reached by climbing the bench behind the northwestern corner of the armor shop.", 1, ".", 0, 2340009) 
...
function step1_complete_talkedToCayan(Quest, QuestGiver, Player)
	...
	-- Red Sun Berries
	AddQuestStepObtainItem(Quest, 2,  "In exchange for his help Cayan Sable requires I help him by collecting Red Sun Berries from the bushes that grow around Starcrest Commune.", 10, 100,  ".", 788,  7814) 
...
function step2_complete_obtainedBerries(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I must return to Cayan Sable, I can use the bench behind the northwest corner of the armor shop to get to him.", 1, ".", 0, 2340009) 
