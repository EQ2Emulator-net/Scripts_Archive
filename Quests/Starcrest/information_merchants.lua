--[[
	Script Name	: Quests/Starcrest/information_merchants.lua
...
function Init(Quest)
	...
	AddQuestStepObtainItem(Quest, 1,  "I need to purchase a bronze statuette from Merchant Zinun Loospankina just northwest of the entrance to the Peat Bog.", 1, 100,  ".", 1059,  10818) 
...
function step1_complete_obtainedStatue(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to inspect the bronze statuette and discover where the information is hidden (Dev Note: Talk to Maareona for now).", 1, ".", 0, 2340001)
...
function step2_complete_inspectedStatuette(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I need to deliver the message to Maareona in the south eastern area of Starcrest Commune.", 1, ".", 0, 2340001)
