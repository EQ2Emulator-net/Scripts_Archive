...
function Step1_Complete_TalkedToTaval(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I should speak to Jana Windstream outside the scribe shop.", 1, "Davyn has told me of reports of a rabid wolf in the Willow Wood. He has asked that I find it and put it out of its misery before anyone is harmed.", 0, 2370034) 
...
function Step3_Complete_SearchedCrate(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 4, "I should follow the wolf tracks that lead eastward up the hill behind the scribe's shop.", 1, 100, "Some wolf tracks lead east of the scribe's shop from the cart. Where there are tracks, there may be a wolf.", 0, 2370042) 
...
function Step4_Complete_KilledWolf(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "I must speak with Davyn.", 1, "Now that the wolf has been slain, I need to speak with Davyn and then Aelis.", 0, 2370008) 
...
function Step5_Complete_TalkedToDavyn(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "I need to speak with Aelis now that I have done a task for Davyn.", 1, "Now that the wolf has been slain, I need to speak with Davyn and then Aelis.", 0, 2370004) 
