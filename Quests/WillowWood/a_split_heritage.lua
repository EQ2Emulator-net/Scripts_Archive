...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "I need to speak with Gar Smolten behind the inn.", 1, "I need to speak with a human named Gar Smolten. Daelyn said he should be behind the inn.", 0, 2370016) 
...
function Step1_Complete_SpokeWithGar(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to speak with Gar Smolten once I know the contents of the boxes.", 1, "I should speak with Gar Smolten behind the inn again when I know which boxes contain what.", 0, 2370016) 
...
function Step2_Complete_SpokeWithGar(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I need to speak with Lia Serene near the entrance to the Elddar Grove.", 1, "I need to speak with an elf named Lia Serene. Daelyn said she should be near the entrance to the Elddar Grove.", 0, 2370039) 
...
function Step4_Complete_FoundEgg(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 23) then
...
function Step6_Complete_FoundEgg(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 23) then
		local egg1 = SpawnMob(GetZone(QuestGiver), 2370145, 0, 815.854, -19.6821, -585.67, 257)
		local egg2 = SpawnMob(GetZone(QuestGiver), 2370145, 0, 815.888, -19.6638, -585.578, 155)
		local egg3 = SpawnMob(GetZone(QuestGiver), 2370145, 0, 815.941, -19.6429, -585.632, 221)
		Despawn(egg1, 300000)
		Despawn(egg2, 300000)
		Despawn(egg3, 300000)
		FoundAllEggs(Quest, QuestGiver, Player)
...
function FoundAllEggs(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 7, "I need to speak with Lia Serene again.", 1, "I should speak with Lia near the entrance to the Elddar Grove again and give her these eggs.", 0, 2370039) 
...
function Step7_Complete_SpokeWithLia(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 8, "I need to speak with Daelyn.", 1, "I should return to Daelyn Twinstar now that I have done what he asked of me.", 0, 2370005) 
