...
function Init(Quest)
	AddQuestStepKill(Quest, 1,  "I must kill some rock adders.", 8, 100,  "I need to kill eight rock adders in the Forest Ruins.", 611, 1960031) 
...
function Step1_Complete_KilledSnakes(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I should return to Hunter Vannil.", 1, "I need to kill eight rock adders in the Forest Ruins.", 0, 2370040) 
