...
function Init(Quest)
	-- Tribute Flower
	AddQuestStepObtainItem(Quest, 1,  "I need to pick some flowers from the Willow Wood and bring them to Aelis.", 8, 100,  "I need to collect some flowers for Davyn's tribute and return them to Aelis.", 1952, 12829) 
...
function Step1_Complete_GotFlowers(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to take these flowers Aelis in the Willow Wood.", 1, "I need to collect some flowers for Davyn's tribute and return them to Aelis.", 0, 2370004) 
...
function Step2_Complete_TalkedToAelis(Quest, QuestGiver, Player)
	...
	while HasItem(Player, 12829) do
		RemoveItem(Player, 12829)
	end

	-- summon Tribute for Ulinir
	if not HasItem(Player, 12830, 1) then
		SummonItem(Player, 12830, 1)
	end
	
	AddQuestStepChat(Quest, 3, "I need to take the completed tribute to Davyn Thornbranch in Willow Wood.", 1, "I need to collect some flowers for Davyn's tribute and return them to Aelis.", 0, 2370008) 
