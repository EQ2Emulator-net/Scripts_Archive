...
function Init(Quest)
	-- Tribute Leaf
	AddQuestStepObtainItem(Quest, 1,  "I need to collect some leaves from the Dewdrop bushes in Willow Wood and bring them to Aelis.", 6, 100,  "I need to collect some leaves for Davyn's tribute and return them to Aelis.", 2098,  12831) 
...
function Step1_Complete_GotLeaves(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to take these leaves back to Aelis in the Willow Wood.", 1, "I need to collect some leaves for Davyn's tribute and return them to Aelis.", 0, 2370004) 
...
function Step2_Complete_TalkedToAelis(Quest, QuestGiver, Player)
	...
	-- Tribute Leaf
	while HasItem(Player, 12831) do
		RemoveItem(Player, 12831)
	end
	
	AddQuestStepChat(Quest, 3, "I need to speak with Davyn and do a task for him.", 1, "I need to collect some leaves for Davyn's tribute and return them to Aelis.", 0, 2370008) 
