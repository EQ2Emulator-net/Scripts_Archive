...
function Step3_Complete_FoundPage7(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I found page 7.")
...
function Step4_Complete_FoundPage11(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I found page 11.")
...
function Step5_Complete_FoundPage12(Quest, QuestGiver, Player)
	UpdateQuestStepDescription(Quest, 1, "I found page 12.")
...
function FoundAllPages(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "I must speak with Daelyn.", 1, "Now that I have collected the missing pages I need to return to Daelyn and speak to him about Milo and Lyssia.", 0, 2370005) 
