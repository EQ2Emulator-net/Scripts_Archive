...
function step2_complete_burntTents(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "Return to Captain Tyreth and tell him you burned the tents.", 1, "The tents are burning. I should return to Captain Tyreth.", 0, 2780149) 
...
function step4_complete_killedOverseer(Quest, QuestGiver, Player)
	...
	--key of the elders
	SummonItem(Spawn, 7312)
	AddQuestStepChat(Quest, 5, "I should return to Captain Tyreth and tell him that I have slain the Tunarian leader.", 1, "I need to report back to Captain Tyreth and tell him that I have slain the Tunarian leader.", 0, 2780149) 
