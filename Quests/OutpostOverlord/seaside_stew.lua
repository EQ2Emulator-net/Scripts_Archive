...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "Seek out Chef Gorga outside the west gate.", 1, "I need to seek out Chef Gorga outside the west gate. She should have some tasks for me to test out my combat skills.", 0, 2780062) 
...
function step1_complete_talkedToGorga(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 2, "Kill the nearby bees to add to Gorga's stew.", 3, 100, "The first ingredient for the Seaside Stew is the nearby bees. I need to kill some for Gorga.", 611, 2780059, 2780092) 
...
function step2_complete_killedBees(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "Return to Chef Gorga.", 1, "I killed the bees that Gorga wants for her stew. I should return to her now.", 0, 2780062) 
...
function step3_complete_talkedToGorga(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 4, "Kill the elk for their livers.", 4, 100, "The second ingredient is elk livers. The elk roam throughout the Seaside Glade, out past the barricades.", 611, 2780093, 2780071, 2780068, 2780060, 2780069) 
...
function step4_complete_killedElk(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "Return the livers to Chef Gorga.", 1, "I've gathered the elk livers and need to return to Chef Gorga.", 0, 2780062) 
...
function step5_complete_talkedToGorga(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "Return to Tayil N'Velex.", 1, "I should return to Tayil N'Velex and let her know that I've finished helping Gorga.", 0, 2780022)
