...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "Talk to Assassin Vamir at the camp in western Seaside Glade.", 1, "I need to find Assassin Vamir in western Seaside Glade. He should have a mission for me.", 0, 2780086) 
...
function step1_complete_talkedToVamir(Quest, QuestGiver, Player)
	...
	AddQuestStepKill(Quest, 2, "Kill wilderbears. They can be found north in the Wilderwood, or west in Cliffdiver Canyon.", 4, 100, "To prevent the Tunarians from recruiting more animals once the attack has begun, I need to take out the animals they use. Bears are up first on the list. I can find bears up north up the slope in the Wilderwood, or west in Cliffdiver Canyon.", 611, 2780096, 2780082, 2780105)
...
function step2_complete_killedBears(Quest, QuestGiver, Player)
	...
	UpdateQuestTaskGroupDescription(Quest, 2, "I killed enough bears and I should return to Assassin Vamir at the camp in Seaside Glade.")
	
	AddQuestStepChat(Quest, 3, "Return to Assasin Vamir.", 1, "I killed enough bears and I should return to Assasin Vamir at the camp in Seaside Glade.", 0, 2780086) 
...
function step3_complete_talkedToVamir(Quest, QuestGiver, Player)
	...
	-- temporary
	SpawnMob(GetZone(Player), 2780090, false, GetX(Player), GetY(Player), GetZ(Player))
	SpawnMob(GetZone(Player), 2780090, false, GetX(Player) + 5, GetY(Player), GetZ(Player) + 5)
	SpawnMob(GetZone(Player), 2780090, false, GetX(Player) + 10, GetY(Player), GetZ(Player) + 10)
	AddQuestStepKill(Quest, 4, "Lure down hawks to kill in Cliffdiver Canyon to the west. I must examine and then release a mole rat in my inventory as bait when I'm in position under a hawk.", 3, 100, "I now need to kill hawks. Vamir gave me some mole rats to use as bait to lure down the hawks that perch high above the cliffs. When I am in position, I need to examine the mole rats in my inventory and then release one. Hopefully it works to lure down the hawks so I can take them out.", 611, 2780090, 2780109)
...
function step4_complete_killedHawks(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "Return to Assasin Vamir.", 1, "I've killed enough hawks and should now return to Assassin Vamir.", 0, 2780086) 
