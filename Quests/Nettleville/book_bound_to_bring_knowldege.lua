...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "Andret can be found at the scribe building, in the Northern corner of town.", 1, "She has asked me to get some books from Andret Surtees.", 718, 2330041)
...
function Step1_Complete_SpokeWithAndret(Quest, QuestGiver, Player)
	...
	-- Stack of books
	if not HasItem(Player, 11538, 1) then
		SummonItem(Player, 11538)
	end
	
	AddQuestStepChat(Quest, 2, "Speak to Helain. She was at the stairs leading to the Mariner's Bell.", 1, "I should return to her, now that I have run the errand.", 0, 2330005)
...
function Quest_Complete(Quest, QuestGiver, Player)
	...
	-- Stack of books
	while HasItem(Player, 11538, 1) do
		RemoveItem(Player, 11538)
	end
