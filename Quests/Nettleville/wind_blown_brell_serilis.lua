...
function Init(Quest)
	AddQuestStepObtainItem(Quest, 1,  "Find the missing pages of the book.", 6, 100,  "With the pages of the book scattered by the wind they could be anywhere in town.", 185,  7802) 
...
function Step1_Complete_FoundPages(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "Speak with Helain, and give her the pages.", 1, "Even though they are a bit dirty, I bet Helain will still be able to read them.", 0, 2330005)
...
function Quest_Complete(Quest, QuestGiver, Player)
	...
	--lost book page
	while HasItem(Player, 7802, 1) do
		RemoveItem(Player, 7802)
	end
