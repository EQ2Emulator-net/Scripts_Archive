...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I need to collect eight bog faerie wings.", 8, 100, "I need to collect eight Bog Faerie Wings from the Peat Bog for Scribe Varion Smitelin.", 110, 1980047, 1980052, 1980053, 1980082, 1980050, 1980046, 1980083, 1980051, 1980042, 1980090, 1980054, 1980040) 
...
function Step1_Complete_GotWings(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to return to Scribe Varion Smitelin.", 1, "I should return these eight Bog Faerie Wings to Scribe Varion Smitelin in Nettleville.", 0, 2330036) 
