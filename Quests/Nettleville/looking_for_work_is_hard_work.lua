...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "I should find Amazu Kharliko hanging out in Market Row near the bank.", 1, "I should find her friends within Nettleville.", 0, 2330016)
...
function Step1_Complete_TalkedToAmazu(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "Andret Surtees can be found with the scribes in the northern most building.", 1, "I should find her friends within Nettleville.", 0, 2330041)
...
function Step2_Complete_TalkedToAndret(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "The armorsmith building in the southeast corner is where I can find Bahati Linnxar.", 1, "I should find her friends within Nettleville.", 0, 2330046)
...
function Step3_Complete_TalkedToBahati(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "Luadine Shardalow should be found at the bank in the southwest building.", 1, "I should find her friends within Nettleville.", 0, 2330014)
...
function Step4_Complete_TalkedToLuadine(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "Luadine Shardalow has sent me to speak with Johfrit Gythell.", 1, "He is in the southern area of town, near The Golden Scabbard armoy.", 0, 2330040)
