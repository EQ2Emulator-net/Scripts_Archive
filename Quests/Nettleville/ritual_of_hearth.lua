...
function Init(Quest)
	AddQuestStepObtainItem(Quest, 1,  "I need to collect some dirt from under the tree on the west side of The Nettleville Market Row in the south western side of Nettleville.", 1, 100,  "Lakosha Maera has asked that I collect some soil from around Nettleville.", 181,  SOIL_ID) -- SpawnGroupID: 159577
	AddQuestStepObtainItem(Quest, 2,  "I need to collect some dirt from under the tree near the entrance to the Peat Bog.", 1, 100,  "Lakosha Maera has asked that I collect some soil from around Nettleville.", 181,  SOIL_ID) -- SpawnGroupID: 159575
	AddQuestStepObtainItem(Quest, 3,  "I need to collect some dirt from in front of the gates to South Qeynos in northwestern Nettleville.", 1, 100,  "Lakosha Maera has asked that I collect some soil from around Nettleville.", 181,  SOIL_D) -- SpawnGroupID: 159576
...
function step1_complete_gotDirtMarket(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 37) then
...
function HarvestedAllDirt(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I need to return to Lakosha Maera on the west side of Nettleville.", 1, "Now that I have collected all of the soil I should return to Lakosha", 0, 2330008) 
	AddQuestStepCompleteAction(Quest, 4, "Quest_Complete")
end

function Quest_Complete(Quest, QuestGiver, Player)
	-- loose soil
	while HasItem(Player, 7789, 1) do
		RemoveItem(Player, 7789)
	end
