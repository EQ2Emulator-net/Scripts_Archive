...
function Init(Quest)
	AddQuestStepObtainItem(Quest, 1,  "Get the crate that fell into the waterways at the Mariner's Bell", 1, 100,  "Johfrit has asked me to pick up some items that are underwater at the Mariner's Bell.", 655,  13443) 
...
function Step1_complete_ObtainedCrate(Quest, QuestGiver, Player)
	...
	AddQuestStepObtainItem(Quest, 2,  "Get the barrel that is also underwater at the Mariner's Bell.", 1, 100,  "Johfrit has asked me to pick up some items that are underwater at the Mariner's Bell.", 2285,  13445) 
...
function Step2_Complete_ObtainedBarrel(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "Return to Johfrit Gythell near The Golden Scabbard armory.", 1, "Johfrit has asked me to pick up some items that are underwater at the Mariner's Bell.", 0, 2330040) 
...
function Step3_Complete_TalkedToJohfrit(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I am to deliver the crate to Amazu Kharliko here, in town.", 1, "I am to deliver the barrel and crate for some coin.", 397, 2330016) 
...
function Step4_Complete_TalkedToAmazu(Quest, QuestGiver, Player)
	...
	-- a waterlogged crate
	while HasItem(Player, 13443, 1) do
		RemoveItem(Player, 13443)
	end
	
	AddQuestStepChat(Quest, 5, "I should take Luadine Shardalow her barrel. She is in the bank.", 1, "I am to deliver the barrel and crate for some coin.", 397, 2330014) 
...
function Step5_Complete_TalkedToLuadine(Quest, QuestGiver, Player)
	...
	-- a waterproof barrel
	while HasItem(Player, 13445, 1) do
		RemoveItem(Player, 13445)
	end
	
	AddQuestStepChat(Quest, 6, "Return to Johfrit Gythell with the money from Amazu and Laudine.", 1, "I am to deliver the barrel and crate for some coin.", 0, 2330040) 
