...
function Accepted(Quest, QuestGiver, Player)
	...
	PlayFlavor(QuestGiver, "thirin_veliumdelver/halas/thirin_veliumdelver/thirin_veliumdelver020.mp3", "", "", 3456248509, 1625770921, Player)
	AddConversationOption(conversation, "I'll be safe, Thirin.")
	StartConversation(conversation, QuestGiver, Player, "And if ye want another, just return here, and grab it.  Brell protect ye, now.  You're going to need it!")
end
