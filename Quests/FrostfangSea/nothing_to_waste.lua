...
function Accepted(Quest, QuestGiver, Player)
	...
	PlayFlavor(QuestGiver, "thirin_veliumdelver/halas/thirin_veliumdelver/thirin_veliumdelver007.mp3", "", "", 3327550252, 85419352, Player)
	AddConversationOption(conversation, "Did you say useless?")
	StartConversation(conversation, QuestGiver, Player, "Good.  The orcs are attacking from the south beach, so seek them out there.  Do some good around here and I may think of you as more than useless.")
end
