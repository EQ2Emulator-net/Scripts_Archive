...
function Accepted(Quest, QuestGiver, Player)
	...
	PlayFlavor(QuestGiver, "thirin_veliumdelver/halas/thirin_veliumdelver/thirin_veliumdelver012.mp3", "", "", 830312044, 2813539587, Player)
	AddConversationOption(conversation, "And you, Thirin.")
	StartConversation(conversation, QuestGiver, Player, "Good.  Brell be with you on your quest, adventurer.")
end
