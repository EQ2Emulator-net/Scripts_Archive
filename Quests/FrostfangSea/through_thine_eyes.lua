...
function Accepted(Quest, QuestGiver, Player)
	...
	PlayFlavor(QuestGiver, "thirin_veliumdelver/halas/thirin_veliumdelver/thirin_veliumdelver016.mp3", "", "", 2746219212, 3926805260, Player)
	AddConversationOption(conversation, "I'll let you know what I learn.")
	StartConversation(conversation, QuestGiver, Player, "Your value grows, adventurer.  You won't be able to use this in the middle of their camp, but I have heard reports say there are a few Ry'gorr on the iceberg to the east of the Jagged Daggers Isle.  See what you find there, perhaps an opportunity to use the eye will present itself.")
end
