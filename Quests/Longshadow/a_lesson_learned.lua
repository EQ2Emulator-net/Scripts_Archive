...
function Accepted(Quest, QuestGiver, Player)
	...
	if not HasItem(Player, 9072) then
		SummonItem(Player, 9072)
...
function Step1_Complete_PlacedBread(Quest, QuestGiver, Player)
	...
	-- Poisoned Loaf of Bread
	RemoveItem(Player, 9072)
	
	-- a loaf of bread
	SpawnMob(GetZone(Player), 1380064, false, -3.04, 1.06, -19.24, 290)
	
	-- Teah
	SpawnMob(GetZone(Player), 1380041, false, 16.79, 0, -16.03, 70.02)
	
	AddQuestStepChat(Quest, 2, "I need to return to Aldera to let her know that I am finished.", 1, "With the bread placed on Lynsia's counter, who showed up but that sloth, Teah?", 0, 1380000)
