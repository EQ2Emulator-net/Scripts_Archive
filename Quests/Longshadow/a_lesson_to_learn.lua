...
function Init(Quest)
	...
	AddQuestStepObtainItem(Quest, 1,  "I need to retrieve a few clumps of Shadows' Kiss for Alders.", 5, 100,  "Aldera has sent me to collect Shadows' Kiss - a small flowery fungus near the sewer.", 318,  8313)
...
function Step1_Complete_GotFungus(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to return to Aldera with the Shadows' Kiss.", 1, "I have collected the Shadows' Kiss for Aldera, I need to return it.", 0, 1380000)
	AddQuestStepCompleteAction(Quest, 2, "Quest_Complete")
end

function Quest_Complete(Quest, QuestGiver, Player)
	-- Shadows' Kiss
	RemoveItem(Player, 10464)
	RemoveItem(Player, 10464)
	RemoveItem(Player, 10464)
	RemoveItem(Player, 10464)
	RemoveItem(Player, 10464)
