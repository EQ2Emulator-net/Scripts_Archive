...
function Init(Quest)
	...
	--AddQuestPrereqRace(Quest, DARK_ELF)

	AddQuestStepChat(Quest, 1, "I need to get an alchemical medium from a man named Kalraath.", 1, "I need to get an alchemical medium from Kalraath. He is near the gate to North Freeport.", 0, 1380037)
...
function Step1_Complete_SpokeToKalraath(Quest, QuestGiver, Player)
	...
	-- Alchemical Medium
	SummonItem(Player, 3043)
	
	AddQuestStepChat(Quest, 2, "I have received the alchemical medium from Kalraath, I need to return to Aldera with it now.", 1, "I have received the alchemical medium I needed from Kalraath. I need to return to Aldera.", 0, 1380000)
...
function Step2_Complete_SpokeToAldera(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "By refreshing my memory with a few questions, Aldera will ensure that no mistakes are made.", 1, "Aldera wants to ensure I understand the task we are undertaking.", 0, 1380000)
	AddQuestStepCompleteAction(Quest, 3, "Quest_Complete")
end

function Quest_Complete(Quest, QuestGiver, Player)
	-- Alchemical Medium
	RemoveItem(Player, 3043)
