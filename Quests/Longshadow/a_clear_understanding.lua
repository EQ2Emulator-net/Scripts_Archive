...
function Step1_Complete_Portal(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 190) then
...
function Multiple_Steps_Complete(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "I will find Aldera V'Exxa near Longshadow Alley's dock.", 1, "Now that I have become familiar with Longshadow Alley, I should return to Aldera V'Exxa at the dock.", 0, 1380000)
