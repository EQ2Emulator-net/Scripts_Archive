...
function Step1_Complete_FreedThaen(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to return to Delcairn Sebastian. He is upstairs in the western half of the northern half of Beggar's Court.", 1, "I need to return to Delcairn.", 0, 1370050)
