...
function step1_complete_examinedKit(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must find Drundo Parn in the tavern and give him a disguised walnut pie.", 1, "I need to visit Drundo, Jayla, and Bolo and set them up for Rondo's pranks.", 0, 2380015)
	AddQuestStepChat(Quest, 3, "I must find Jayla Midhop outside the armory and give her this forged note.", 1, "I need to visit Drundo, Jayla, and Bolo and set them up for Rondo's pranks.", 0, 2380040)
	AddQuestStepChat(Quest, 4, "I must find Bolo Brassharp outside of the inn and convince him to see Jayla with a bloat pie.", 1, "I need to visit Drundo, Jayla, and Bolo and set them up for Rondo's pranks.", 0, 2380005)
...
function step2_complete_talkedToDrundo(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 72) then
...
function pranks_given(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "I have done what Rondo wanted and should return to him.", 1, "Now that Rondo's pranks are ready to go, I should speak with him.", 0, 2380002)
...
function quest_complete(Quest, QuestGiver, Player)
	...
	while HasItem(Player, 9136) do
		RemoveItem(Player, 9136)
	end
