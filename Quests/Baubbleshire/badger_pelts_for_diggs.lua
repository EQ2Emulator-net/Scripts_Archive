...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I need ten badger pelts.", 10, 100, "I must collect ten badger pelts in the Forest Ruins.", 93, 1960018, 1960028)
...
function step1_complete_killedBadgers(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must return to Armorsmith Diggs.", 1, "I must return to Armorsmith Diggs in Baubbleshire.", 0, 2380041)
