...
function Init(Quest)
	...
	AddQuestStepObtainItem(Quest, 1,  "I need to collect some Misty Thicket Shadeblooms from around the Baubbleshire.", 6, 100,  "I need to collect some Misty Thicket Shadeblooms and see if they will help convince Maela to get her feelings off of her chest.", 1946, 2082)
...
function step1_complete_gotFlowers(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I should speak with Maela now that I have these Shadeblooms.", 1, "I need to collect some Misty Thicket Shadeblooms and see if they will help convince Maela to get her feelings off of her chest.", 0, 2380020)
...
function step2_complete_talkedToMaela(Quest, QuestGiver, Player)
	...
	-- a Misty Thicket Shadebloom
	while HasItem(Player, 2082) do
		RemoveItem(Player, 2082)
	end
	
	AddQuestStepChat(Quest, 3, "I should return to Rondo and let him know the good news.", 1, "I need to collect some Misty Thicket Shadeblooms and see if they will help convince Maela to get her feelings off of her chest.", 0, 2380002)
