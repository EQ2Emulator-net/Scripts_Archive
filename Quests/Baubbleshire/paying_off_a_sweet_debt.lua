...
function step1_complete_gotHoney(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "Now that I have collected this honey, I should return to Rondo.", 1, "Rondo has asked that I collect some honey from the trees around the Baubbleshire.", 0, 2380002)
