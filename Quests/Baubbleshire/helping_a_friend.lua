...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "I need to speak with Maela Meadows near the waterfall in southeastern Baubbleshire.", 1, "I need to see if I can help Maela deal with any problems she may have.", 0, 2380020)
...
function step1_complete_talkedToMaela(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I should return to Rondo.", 1, "I need to see if I can help Maela deal with any problems she may have.", 0, 2380002)
