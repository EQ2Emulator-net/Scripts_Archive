...
function Init(Quest)
	-- Scrap Metal
	AddQuestStepObtainItem(Quest, 1,  "I need to collect some scrap metal for Neezer Grund.", 7, 100,  "I need to scour the Baubbleshire for some scrap metal.", 64, 10370) 
...
function step1_complete_gotMetal(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to return this scrap metal to Neezer Grund.", 1, "I need to scour the Baubbleshire for some scrap metal.", 0, 2380003)
...
function quest_complete(Quest, QuestGiver, Player)
	...
	-- Remove Scrap Metal
	while HasItem(Player, 10370) do
		RemoveItem(Player, 10370)
	end
