...
function Init(Quest)
	AddQuestStepKill(Quest, 1, "I must kill some forgotten guardians.", 5, 100, "I need to slay five Forgotten Guardians in the Forest Ruins.", 611, 1960033, 1960140, 1960034, 1960094, 1960093)
...
function step1_complete_killedGuardians(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must return to Marshal Surefoot.", 1, "I need to return to Marshal Surefoot in Baubbleshire.", 0, 2380009)
