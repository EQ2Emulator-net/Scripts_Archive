...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "I need to pick a fight with Marus Donoval. I need should make a joke about the smell of his feet. Burk says he should be in the tavern.", 1, "Burk has given me a list of people, their locations, and insults meant to goad them into fighting me.", 0, 2350037) 
	AddQuestStepChat(Quest, 2, "I need to pick a fight with Angus Fallowfur. I should make a joke about his baldness. Burk says he should be behind the armory, on the corner closest to the docks.", 1, "Burk has given me a list of people, their locations, and insults meant to goad them into fighting me.", 0, 2350013)
	AddQuestStepChat(Quest, 3, "I need to pick a fight with Dunda Frostgrip. I should make mention of Mav Boilfist near her. Burk says I can find her just south-west of the scribe's shop.", 1, "Burk has given me a list of people, their locations, and insults meant to goad them into fighting me.", 0, 2350052)
...
function step1_completed_talkedToMarus(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 15) then
...
function insultsGiven(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I need to return to Burk Stoneshatter near the docks.", 1, "I should return to Burk now that I've been in a few fights.", 0, 2350009)
