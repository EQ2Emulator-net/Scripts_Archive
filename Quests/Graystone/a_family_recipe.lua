...
function Step1_Complete_FoundCherries(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 24) then
...
function FoundAllItems(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I need to bring all of these components to Mav Boilfist near the docks.", 1, "I need to bring these ingredients to Mav Boilfist in Graystone Yard.", 0, 2350019) 
