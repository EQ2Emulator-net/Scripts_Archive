...
function Init(Quest)
	AddQuestStepChat(Quest, 1, "I need to speak with the shipping coordinator on the docks.", 1, "I need to get Mav's package for her.", 0, 2350005) 
...
function Step2_Complete_FoundMavsPackage(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I need to clear this package with the shipping coordinator.", 1, "I need to get Mav's package for her.", 0, 2350005) 
...
function Step3_Complete_SpokeWithShippingCoordinator(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I need to deliver Mav's package to her.", 1, "I need to get Mav's package for her.", 0, 2350019) 
