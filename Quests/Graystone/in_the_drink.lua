...
function Accepted(Quest, QuestGiver, Player)
	...
	-- Location Buoys
	if not HasItem(Player, 7755, 1) then
		SummonItem(Player, 7755, 1)
	end
...
function step1_complete_buoy1Attatched(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 65) then
...
function all_buoys_placed(Quest, QuestGiver, Player)
	...
	-- Location Buoys
	while HasItem(Player, 7755) do
		RemoveItem(Player, 7755)
	end
	
	AddQuestStepChat(Quest, 4, "I need to tell the Shipping Coordinator that everything is hooked up.", 1, "I have recovered Burk's package, along with other portions of the missing shipment, from the water.", 0, 2350005)
...
function step4_complete_talkedToCoordinator(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "I need to give Burk his package.", 1, "I have recovered Burk's package, along with other portions of the missing shipment, from the water.", 0, 2350009)
