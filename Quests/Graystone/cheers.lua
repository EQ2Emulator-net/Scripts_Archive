...
function Step1_Complete_GotBrewFromKeg(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to give some of Mav's brew to Gnor Farven in the tavern.", 1, "I need to give samples of Mav's brew to a number of people around Graystone Yard.", 0, 2350038) 
	AddQuestStepChat(Quest, 3, "I need to give some of Mav's brew to Gurna Hadel in the tavern.", 1, "I need to give samples of Mav's brew to a number of people around Graystone Yard.", 0, 2350045) 
	AddQuestStepChat(Quest, 4, "I need to give some of Mav's brew to Dunda Frostgrip southwest of the scribe's shop.", 1, "I need to give samples of Mav's brew to a number of people around Graystone Yard.", 0, 2350052) 
...
function Step2_Complete_SpokeWithGnor(Quest, QuestGiver, Player)
	...
	-- Mav's Brew
	if HasItem(Player, 7989) then
		RemoveItem(Player, 7989)
	end
	
	if QuestIsComplete(Player, 295) then
...
function SpokeWithAllFriends(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "I need to speak with Mav Boilfist.", 1, "I should return to Mav and let her know what everyone thought of her brew.", 0, 2350019) 
