...
function Accepted(Quest, QuestGiver, Player)
	...
	-- Mav's Stone
	if not HasItem(Player, 7990, 1) then
		SummonItem(Player, 7990, 1)
	end
...
function Step1_Complete_ExaminedStone(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I should return to Mav Boilfist.", 1, "I need to take Mav's stone to the Stone of Kaladim here in the Graystone Yard and see if anything interesting happens.", 0, 2350019) 
...
function Quest_Complete(Quest, QuestGiver, Player)
	...
	-- Mav's Stone
	while HasItem(Player, 7990) do
		RemoveItem(Player, 7990)
	end
