...
function Init(Quest)
	AddQuestStep(Quest, 1, "I should check the Overflow Manifest that Burk gave me to figure out where I might find the Graystone Courier.", 1, "I need to figure out what has happened to Burk's package.", 0)
...
function Accepted(Quest, QuestGiver, Player)
	...
	-- Overflow Manifest
	if not HasItem(Player, 8895, 1) then
		SummonItem(Player, 8895, 1)
	end
...
function step1_complete_inspectedManifest(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to ask the Graystone Courier about Burk's shipment. I should check the locations given on the Overflow Manifest.", 1, "I need to figure out what has happened to Burk's package.", 0, 2350010)
...
function step2_complete_talkedToCourier(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "The courier doesn't have Burk's package, but suggested I talk to the Shipping Coordinator on the docks.", 1, "I need to figure out what has happened to Burk's package.", 0, 2350005)
...
function step3_complete_talkedToCoordinator(Quest, QuestGiver, Player)
	...
	-- Overflow Manifest
	while HasItem(Player, 8895) do
		RemoveItem(Player, 8895)
	end
...
function step4_complete_inspectedBarrels(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 5, "Burk's shipment was not among the newer boxes, I should speak with the Shipping Coordinator again.", 1, "I still have not found Burk's package.", 0, 2350005)
...
function step5_complete_talkedToCoordinator(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "The Shipping Coordinator has suggested I speak with the dock loader, Marus Donoval. He says he should be in the tavern.", 1, "I still have not found Burk's package.", 0, 2350037)
...
function step6_complete_talkedToMarus(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 7, "Marus Donoval thinks some crates may have fallen into the water. I should speak with the Shipping Coordinator about this.", 1, "I still have not found Burk's package.", 0, 2350005)
