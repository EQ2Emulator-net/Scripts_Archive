--[[
	...
	Script Purpose	: Quest 162, Kill or be killed.
	Script Author	: Xanibunib
	Script Date	: 3.30.2009
	
	Zone       : Scale Yard
	Quest Giver: Brrod Matron Vrim Malthyk
	Quest ID#	: 162
...
function Init(Quest)
	...
	AddQuestStepKill(Quest, 1, "Anthony Glavias must be relived of his duty as a member of the Freeport Militia.", 1, 100, "Militia member, Anthony Glvias, has proven to be too incompetant to serve in the Freeport Militia. He must be relived of his duty. He is currently stationed West of the Fountain of the Fallen Soldier.", 0, 1390035)
...
function AnthonyDead(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must inform Vrim of my actions.", 1, "I must speak with Vrim.", 0, 1260055)
