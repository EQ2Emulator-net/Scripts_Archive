...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "I must speak with Tristan. He is standing near the Heated Stone Inn.", 1, "I need to manipulate two Barbarians into hating each other.", 0, 1390007)
...
function Step1_Complete_Tristan(Quest, QestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I must speak with Wesley Tundrafoot. He is standing near the South Freeport gate.", 1, "I need to manipulate two Barbarians into hating each other.", 0, 1390029)
...
function Step2_Complete_Wesley(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "These two Barbarians have completely fallen for my ruse. I must report back to Vrim.", 1, "I need to speak with Vrim", 0, 1260055)
