...
function Step1_Complete_Threat(Quest, QuestGiver, Player)
	...
	AddQuestStepObtainItem(Quest, 2,  "I must recover the box of alchemy components. They are suppose to be near the enterance to the Thieve's Way.", 1, 100,  "I need to look for the stolen box of alchemy components.", 654,  3401)
