...
function Init(Quest)
	...
	AddQuestStepChat(Quest, 1, "I need to yell at Vleske Vylkle. I think I see him standing near some stairs.", 1, "I need to yell a fierce war cry at several people here in the Scale Yard!", 0, 1390018) 
...
function Step1_YelledAtVleske(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 2, "I need to yell at Caleb Brazenroot. He was seen near the Heated Stone Inn.", 1, "I need to yell a fierce war cry at several people here in the Scale Yard!", 0, 1390008)
...
function Step2_YelledAtCaleb(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 3, "I need to yell at Jondy Cobbleblork. He is said to be near the Freeport Reserve.", 1, "I need to yell a fierce war cry at several people here in the Scale Yard!", 0, 1390046)
...
function Step3_YelledAtJondy(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I should let Malachi know I've yelled at everyone.", 1, "I should go speak with Malachi", 0, 1390077)
