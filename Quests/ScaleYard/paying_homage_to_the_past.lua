--[[
	...
	QuestID #	: 152
	Preceded by	: He said, he said 151
...
function Step2_Complete_GotSkulls(Quest, QuestGiver, Player)
	...
	AddQuestStepSpell(Quest, 3, "I must place the skulls in the brazier.", 1, 100, "I must place the skulls in the brazier and set them ablaze. I saw a brazier in Vrim's quarters, up the stairs, northeast of the docks.", 0, 5021)
...
function Step3_Complete_SkullsInFire(Quest, QuestGiver, Player)
	...
	RemoveItem(Spawn, 3245)
	AddQuestStepSpell(Quest, 4, "I need to take the shackles off the wall.", 1, 100, "It Appears that the Iksar were once enslave by the Overlord. However, after proving their mettle during the Battle of Defiance, the Iksar were allowed to live freely in the Scale Yard. I am to take the old shackles from the time of enslavement and cast them into the sea!", 0, 5022)
...
function Step5_Complete_TossShackles(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 6, "I have completed all the tasks mentioned in the tome. Though only a short lesson, I feel I know much more about the past glories and struggles my people have endured.", 1, "The ritual is complete. I must speak with Vrim", 0, 1260055)
