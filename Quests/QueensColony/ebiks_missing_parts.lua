...
function Init(Quest)
	...
	AddQuestStepLocation(Quest, 1, "I still need to get a size 7 clunker. Perhaps Ebik lost it while getting a better view of the bay."  , 20, "I need to find the three items that were lost on this island. I should keep an eye out while I explore the colony.", 173, 7   ,  2 , -117)
	AddQuestStepLocation(Quest, 2, "I still need to get a copper-coated springer. It's possible Ebik could have lost it over the side of the ship.", 20, "I need to find the three items that were lost on this island. I should keep an eye out while I explore the colony.", 216, -143, -15,  161)
	AddQuestStepLocation(Quest, 3, "I still need to get a triangle spinner. Maybe Ebik was trying to run from something and dropped it?" , 20, "I need to find the three items that were lost on this island. I should keep an eye out while I explore the colony.", 86, -79 ,  5 , -154)
...
function step1_complete(Quest, QuestGiver, Player)
	...
	if QuestIsComplete(Player, 8) then
...
function givePartsToEbik(Quest, QuestGiver, Player)
	...
	AddQuestStepChat(Quest, 4, "I should bring these parts back to Ebik.", 1, "I found all the parts Ebik needs and I should return them to him.", 0, 2530045) 
