...
function Init(Quest)
	...
	-- Qeynosian Bard's Dagger
	-- Qeynosian Brawler's Wraps
	-- Qeynosian Cleric's Hammer
	-- Qeynosian Crusader's Greatsword
	-- Qeynosian Druid's Scimitar
	-- Qeynosian Enchanter's Wand
	-- Qeynosian Predator's Dagger
	-- Qeynosian Rogue's Rapier
	-- Qeynosian Shaman's Spear
	-- Qeynosian Sorcerer's Staff
	-- Qeynosian Summoner's Dagger
	-- Qeynosian Warrior's Axe 
